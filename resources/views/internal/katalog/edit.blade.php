        ...
        <form method="POST" action="{{ request('revisi') ? route('internal.katalog.revisi', $dataset) : route('internal.katalog.update', $dataset) }}" enctype="multipart/form-data" class="bg-white rounded-xl shadow-sm border p-8 space-y-6">
            ...
            <div class="grid md:grid-cols-2 gap-4">
                ...
                <div class="md:col-span-2">
                    ...
                    <textarea name="deskripsi" rows="4" class="w-full px-4 py-2.5 border border-gray-300 rounded-lg focus:ring-2 focus:ring-primary-500 focus:border-primary-500 outline-none">{{ old('deskripsi', $dataset->deskripsi) }}</textarea>
                </div>
                <div class="md:col-span-2">
