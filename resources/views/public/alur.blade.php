    ...
    <div class="bg-gradient-to-br from-primary-500 to-primary-700 text-white">
        <div class="max-w-7xl mx-auto px-4 py-16 md:py-24 text-center">
            ...
            <div class="flex flex-wrap justify-center gap-4 mt-8">
                <a href="{{ route('permintaan.create') }}" class="bg-white text-primary-600 font-semibold px-6 py-3 rounded-lg shadow hover:bg-gray-100 transition">Mulai Sekarang</a>
        ...
        @php
            $steps = [
                [
                    ...
                    'deskripsi' => 'Masukkan nomor HP aktif Anda untuk menerima kode OTP sebagai validasi identitas.',
                ...
                [
                    ...
                    'deskripsi' => 'Anda dapat mengunduh file data yang diminta langsung dari portal menggunakan nomor tiket Anda.',
                    'warna' => 'bg-yellow-500',
    ...
    <div class="max-w-7xl mx-auto px-4 mt-16">
        <div class="bg-gradient-to-br from-secondary-500 to-secondary-700 text-white rounded-3xl shadow-xl p-8 md:p-12 text-center relative overflow-hidden">
            ...
            <div class="flex flex-wrap justify-center gap-4 mt-8 relative">
                <a href="{{ route('permintaan.create') }}" class="bg-white text-secondary-600 font-semibold px-8 py-3 rounded-lg shadow hover:bg-gray-100 transition">Ajukan Sekarang</a>
